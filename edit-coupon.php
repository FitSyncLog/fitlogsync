...
if ($result->num_rows > 0) {
    ...
    <head>
        ...
        <title>Edit Coupons | FiT-LOGSYNC</title>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-body">
                                ...
                                <?php
                                $coupon_id = isset($_GET['coupon_id']) ? htmlspecialchars($_GET['coupon_id']) : '';

                                if (empty($coupon_id)) {
                                    echo "<div class='alert alert-danger'>Invalid coupon ID.</div>";
                                    exit();
                                }

                                // Prepare the query to fetch coupon details
                                ...
                                if ($result->num_rows > 0) {
                                    ...
                                    $coupon_type = htmlspecialchars($coupon['coupon_type']);
                                    $coupon_value = htmlspecialchars($coupon['coupon_value']);
                                    $number_of_coupons = htmlspecialchars($coupon['number_of_coupons']);
                                    $start_date = htmlspecialchars($coupon['start_date']);
                                    $end_date = htmlspecialchars($coupon['end_date']);
                                    ?>

                                    <div class="text-center text-muted my-3">
                                        <i class="fas fa-solid fa-ticket fa-10x"></i>
                                        <h3> <?php echo $coupon_name ?></h3>
                                        <p>Coupon Name/Event Name</p>
                                    </div>

                                    <form action="indexes/edit-coupon.php" method="POST">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button type="submit" class="btn btn-warning" name="editCoupon">Edit Coupon</button>
                                        </div>
                                    </form>

                                    <?php
                                } else {
                                    echo "<div class='alert alert-danger'>Coupon not found.</div>";
                                    exit();
                                }
                                ?>
                            </div>
